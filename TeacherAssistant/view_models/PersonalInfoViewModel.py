...
#from MyJobAssistant.models import PersonalInfoModel as pModel
import TeacherAssistant
from TeacherAssistant.models import PersonalInfoModel as model
...
class PersonalInfoViewModel(NotifyPropertyChanged):
    ...
    @overload
    def __init__(self, arg__1:model.PersonalInfoModel) -> None:...
        # Initialization for UPDATE mode.
        #pass
      
    def __init__(self, arg__1: Optional[model.PersonalInfoModel] = None) -> None:
        ...
        if arg__1 is None:
            # INSERT mode
            self.old_id = None
            self.__model = model.PersonalInfoModel(TeacherAssistant.db_connection.cursor())
        else:
            # UPDATE mode
            self.old_id = arg__1[0]
            self.__model = arg__1  # Use the provided model instance
    ...
    def save(self):  
        ...
        bool_, result = self.__model.save(self.id, self.fname, self.lname, self.birth_date, self.gender, self.phone, self.address,
