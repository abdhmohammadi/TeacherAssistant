...
def create_rounded_pixmap(original_pixmap:QPixmap,style="all", radius=10):
    """
    Create rounded pixmap with predefined styles
    
    Styles:
        "all": All corners rounded
        "top": Only top corners rounded
        "bottom": Only bottom corners rounded
        "left": Only left corners rounded
        "right": Only right corners rounded
        "top-left": Only top-left corner rounded
        "message": Rounded speech bubble style
    """
    ...
    if style == "all":
        ...
        # Speech bubble style (rounded except arrow point)
        path.moveTo(radius, 0)
        path.lineTo(w - radius, 0)
        path.arcTo(w - 2*radius, 0, 2*radius, 2*radius, 90, -90)
        path.lineTo(w, h - radius - 20)
        path.arcTo(w - 2*radius, h - 2*radius - 20, 2*radius, 2*radius, 0, -90)
        path.lineTo(w//2 + 10, h - 20)
        path.lineTo(w//2, h)
        path.lineTo(w//2 - 10, h - 20)
        path.lineTo(radius, h - 20)
        path.arcTo(0, h - 2*radius - 20, 2*radius, 2*radius, 270, -90)
        path.lineTo(0, radius)
        path.arcTo(0, 0, 2*radius, 2*radius, 180, -90)
        path.closeSubpath()
